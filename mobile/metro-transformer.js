/**
 * Metro transformer that injects FormData polyfill at the very beginning of index.js
 */

const upstreamTransformer = require('metro-react-native-babel-transformer');

module.exports.transform = function({ src, filename, options }) {
  // Inject FormData polyfill at the very beginning of index.js
  if (filename.includes('index.js') || filename.includes('index.ts')) {
    const formDataPolyfill = `
// FormData polyfill - injected by Metro transformer
(function() {
  'use strict';
...
`;
    ...
    src = formDataPolyfill + '\n' + src;
  }

  // Use the default transformer for everything else
